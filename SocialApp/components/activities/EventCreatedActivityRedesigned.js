// components/activities/EventCreatedActivityRedesigned.js - Redesigned to match new style
...
const EventCreatedActivityRedesigned = ({ 
  activity, 
  currentUserId, 
  navigation, 
  onAction 
...
export default EventCreatedActivityRedesigned;
